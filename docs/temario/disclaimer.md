...
| | Google (Documents/Sheets) | Python |
|---|:-:|:-:|
| ¿Cuántas coincidencias devuelve? | Todas / Algunas | Todas |
...
| Fase | Descripción |
|---|---|
| **0 - [Google Colab](https://es.wikipedia.org/wiki/Google_Colab) como herramienta** | El entorno no es un Word especial. Hay celdas de texto y celdas de código. La tarea de esta fase es reconocer el entorno y ejecutar una celda antes de ver una sola línea de Python. |
